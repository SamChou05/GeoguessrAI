...
1. [Abstract](https://github.com/SamChou05/GeoguessrAI/blob/main/README.md#abstract)
2. [Problem Statement](https://github.com/SamChou05/GeoguessrAI/blob/main/README.md#problem-statement)
3. [Related Work](https://github.com/SamChou05/GeoguessrAI/blob/main/README.md#related-work)
4. [Methodology](https://github.com/SamChou05/GeoguessrAI/blob/main/README.md#methodology)
5. [Results](https://github.com/SamChou05/GeoguessrAI/blob/main/README.md#results)
6. [Examples](https://github.com/SamChou05/GeoguessrAI/blob/main/README.md#examples)
7. [Demo](https://github.com/SamChou05/GeoguessrAI/blob/main/README.md#demo)
8. [Video](https://github.com/SamChou05/GeoguessrAI/blob/main/README.md#video)
9. [Looking Forward](https://github.com/SamChou05/GeoguessrAI/blob/main/README.md#looking-forward)
...
There are many variables that go into making a good guess: climate, architecture, street signs, vegetation, vibes, and more. However, what if we could save people the brainpower required to make an educated guess? That's where __GeoguessrAI__ comes in!

GeoguessrAI is a neural network that has been trained on tens of thousands of street view images from around the world, and is able to guess with a respectable amount of accuracy the location of any street view image thrown its way.
...
1. Clone the repo:
    ```
    git clone git@github.com:SamChou05/GeoguessrAI.git
    ```
